...
const portfolio = {
    ...
    // 🔹 Skills
    // =======================
    // Ordered deliberately: the AI-systems work leads, language and framework
    // lists sit underneath as foundations rather than headline skills.
    skills: {
      agentArchitecture: [
        "LLM Orchestration",
        "Agent Loops",
      ...
      modelRouting: [
        ...
        "OpenAI API",
        "Llama-3.3-70B",
        "Token Streaming (NDJSON/SSE)",
      ],
      contextMemory: [
        "Context Management",
        "Session Persistence",
        "Cross-Model Context Sync",
        "Conversation Memory",
    ...
    // =======================
    about:
      "Hi, I’m Chandra Pavan Reddy Chada — an engineer who builds AI systems rather than wrappers around them. Most of my recent work is agent architecture: orchestration loops that plan and chain tools, multi-model routing with local inference and fallback chains, context and memory that survive across sessions and models, and the guardrails, structured-output repair, and cost observability that keep all of it dependable. It ships on a full-stack foundation — Python and TypeScript, React and FastAPI, Postgres and Kubernetes — because an agent is only as useful as the product it lives inside.",
    // =======================
    // 🔹 Contact Info
    // =======================
    contact: {
